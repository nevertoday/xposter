(() => {
  function register(i18n, shared, constants = {}) {
    ...
    const ZH_TEXT = new Map(
      ...
      "Publish readiness": "发布准备状态",
      X: "X",
      "Open X Articles": "打开 X 文章",
      "Paste or choose Markdown.": "粘贴或选择 Markdown。",
      Assets: "素材",
      "Waiting for draft.": "等待草稿。",
      "Optional until needed.": "需要时再处理。",
      "Open X Articles.": "打开 X 文章页。",
      "Connect the target page.": "连接目标页面。",
      "Open X Articles to connect the target.": "打开 X 文章来连接目标页面。",
      Open: "打开",
      Refresh: "刷新",
      "Run Check to confirm target.": "运行检查确认目标。",
      "Run Check to confirm this article.": "运行检查，确认这篇文章。",
      "Refresh X Article": "刷新 X 文章",
      "Check X Article": "检查 X 文章",
      "Run Check before writing.": "写入前先运行检查。",
      "Editor ready.": "编辑器就绪。",
      "Article editor is ready.": "文章编辑器已就绪。",
      "Can create a draft.": "可创建草稿。",
      "X Articles is open; xPoster can create a draft.": "X 文章页已打开，xPoster 可以创建草稿。",
      "Can create": "可创建",
      "{count} queued draft(s).": "队列中有 {count} 篇草稿。",
      Queue: "队列",
      "{count} publishable block(s), {titleState}.": "{count} 个可发布块，{titleState}。",
      "title ready": "标题就绪",
      "no title": "无标题",
      Loaded: "已载入",
      Review: "检查",
      "Local image path blocked.": "本地图片路径被阻止。",
      "Reduce images": "减少图片",
      "Fix image paths": "修复图片路径",
      "Open details to fix image handling.": "打开详情处理图片。",
      "Choose image folder": "选择图片文件夹",
      "Check image upload": "检查图片上传",
      "Open details to finish image handling.": "打开详情完成图片处理。",
      Limit: "上限",
      Folder: "文件夹",
      "Text only": "纯文本",
      "Ready to write": "可以写入",
      "Click the Write button below when you are ready.": "准备好后点击下方写入按钮。",
      "Needs attention": "需要处理",
      "No image or table uploads required.": "无需上传图片或表格。",
      "{count} generated cover candidate(s) ready.": "{count} 张生成封面候选已准备好。",
      Generated: "已生成",
      Off: "关闭",
      "Cover import is off; generation still works.": "封面导入关闭，仍可直接生成。",
      "Draft cover source is ready.": "草稿封面来源已准备好。",
      Detected: "已检测",
      "Generate one or add frontmatter cover.": "生成一张，或添加 frontmatter cover。",
      Missing: "缺失",
      ...
      "Preparing the article and X editor.": "正在准备文章和 X 编辑器。",
      "Checking image files before upload.": "正在检查图片文件，尚未上传到 X。",
      ...
      "AI cover generator": "AI 封面生成",
      "Use your own image API key to generate 5:2 article cover candidates.": "使用你自己的图像 API key 生成 5:2 文章封面候选图。",
      "AI article cover": "AI 文章封面",
      "Generate 5:2 cover candidates from selected text, then set one as the current X Article cover.": "根据选中文本生成 5:2 封面候选图，再把满意的一张设为当前 X 文章封面。",
      "Image API keys": "图像 API Key",
      "API keys": "API Key",
      Manage: "管理",
      Open: "打开",
      "Cover generation": "封面生成",
      "Generate cover": "生成封面",
      "Generate article cover": "生成文章封面",
      "Load Markdown or write a cover idea when ready.": "加载 Markdown，或准备好后直接写封面想法。",
      "Cover import is off; direct cover generation still works.": "封面导入已关闭；仍可直接生成封面。",
      "Draft already has a cover source; generate only if you want a replacement.": "草稿已有封面来源；需要替换时再生成。",
      "No cover source found; generate one when ready.": "没有检测到封面来源；准备好后可以生成一张。",
      "Recent covers": "最近封面",
      "Prompt profiles": "封面风格",
      "Cover styles": "封面风格",
      "Name reusable cover styles, then pick one before generating.": "给常用封面风格命名，生成前选择一个即可。",
      "Pick the reusable visual style for AI cover generation.": "选择 AI 生成封面时复用的视觉风格。",
      "Saved cover styles": "已保存的封面风格",
      "Choose the style AI should reuse for the next cover.": "选择下一张封面要复用的风格。",
      "Edit cover style": "编辑封面风格",
      "Edit or create a style": "编辑或新建风格",
      "Write reusable visual rules for this account. The cover idea is added later.": "写下这个账号可复用的视觉规则；封面想法会在生成时再加入。",
      "Add, activate, and test keys used for cover generation.": "添加、启用并测试用于封面生成的 Key。",
      "Add and manage keys used for cover generation.": "添加和管理用于封面生成的 Key。",
      "Set the style, add source text, generate candidates, then choose one cover.": "设置风格、添加来源文本、生成候选图，再选择一张封面。",
      "Write a cover idea, generate candidates, then choose one.": "写下封面想法，生成候选图，再选择一张。",
      "Add a cover idea, generate candidates, then choose one.": "添加封面想法，生成候选图，再选择一张。",
      "Add an API key to start.": "添加 API Key 后就可以生成。",
      "Add image API key": "添加图像 API Key",
      Platform: "平台",
      OpenAI: "OpenAI",
      Gemini: "Gemini",
      "Custom compatible API": "自定义兼容 API",
      "Custom API": "OpenAI 兼容 API",
      "OpenAI-compatible API": "OpenAI 兼容 API",
      "API key": "API key",
      "OpenAI-compatible API Base URL": "OpenAI 兼容 API Base URL",
      "Key name": "Key 名称",
      "Add key": "添加 Key",
      "Manage key": "管理 Key",
      "No API keys added yet.": "还没有添加 API key。",
      "Choose a platform first. Custom platforms need an OpenAI-compatible /v1 endpoint.": "选择 OpenAI，或填写 OpenAI 兼容的 /v1 图像接口。",
      "Use an OpenAI-compatible /v1 endpoint, for example https://api.openai.com/v1.": "使用 OpenAI 兼容的 /v1 地址，例如 https://api.openai.com/v1。",
      "Use OpenAI, or choose OpenAI-compatible API for another /v1 image endpoint.": "使用 OpenAI，或选择 OpenAI 兼容 API 填写其他 /v1 图像接口。",
      "Choose OpenAI, Gemini, or another OpenAI-compatible image endpoint.": "选择 OpenAI、Gemini，或其他 OpenAI 兼容的图像接口。",
      "Keys are saved locally in this browser.": "Key 会保存在当前浏览器本地。",
      "Connection check": "连接检查",
      "The key is tested before it is saved.": "保存前会先测试这个 Key 是否可用。",
      "Connection not tested": "尚未测试连接",
      "Paste an API key first.": "请先粘贴 API key。",
      "Testing...": "测试中...",
      "Testing API connection...": "正在测试 API 连接...",
      "Testing connection": "正在测试连接",
      "Checking {provider} with {model}...": "正在用 {model} 检查 {provider}...",
      "Connection verified": "连接已通过",
      "Connection failed": "连接失败",
      "{provider} responded with {model}.": "{provider} 已响应 {model}。",
      "{provider} responded with {model}. This key is now active.": "{provider} 已响应 {model}，这个 Key 已启用。",
      "API key verified, added, and activated.": "API key 已验证、添加并启用。",
      Active: "启用中",
      Activate: "启用",
      Test: "测试",
      Stored: "已保存",
      "Test passed": "测试通过",
      "Test failed": "测试失败",
      "Paste an API key before adding it.": "请先粘贴 API key。",
      "Enter a compatible API Base URL.": "请填写兼容的 API Base URL。",
      "Use an HTTPS URL, or http:// for a local address.": "请使用 HTTPS 地址，本地地址可用 http://。",
      "Could not reach the API. Check the Base URL and your connection.": "无法连接 API，请检查 Base URL 和网络连接。",
      "Key saved": "Key 已保存",
      "{provider} accepted the key. {model} is checked on the first cover.": "{provider} 已接受该 Key，{model} 将在首次生成封面时验证。",
      "Key saved. It is checked on the first cover.": "Key 已保存，将在首次生成封面时验证。",
      "API key added and activated.": "API key 已添加并启用。",
      "API key activated.": "API key 已启用。",
      "API key removed.": "API key 已移除。",
      "API key test passed.": "API key 测试通过。",
      "API key test failed: {error}": "API key 测试失败：{error}",
      "API host permission is not available in this browser context.": "当前浏览器环境无法申请 API 域名权限。",
      "API host permission was not granted.": "没有获得 API 域名访问权限。",
      "Default prompt": "默认提示词",
      "Style prompt": "风格提示词",
      "Style description": "风格描述",
      "Style name": "风格名称",
      "Editorial calm": "编辑感留白",
      "Save style": "保存风格",
      "Save changes": "保存修改",
      "New style": "新建风格",
      "No prompt profiles yet.": "还没有封面风格。",
      "No cover styles yet.": "还没有封面风格。",
      "No style prompt yet.": "还没有风格提示词。",
      "No style description yet.": "还没有风格描述。",
      "Describe the reusable cover style for this account...": "描述这个账号可复用的封面风格...",
      "Composition, tone, typography, colors, and things to avoid...": "构图、气质、字体、颜色，以及需要避免的元素...",
      "This style is combined with the cover idea when generating.": "生成时会把这个风格和封面想法组合起来。",
      "These rules are reused with each cover idea.": "这些规则会和每次的封面想法一起使用。",
      "Choose a cover style before generating.": "生成前选择一个封面风格。",
      "Choose a style or edit the reusable visual rules.": "选择一个风格，或编辑可复用的视觉规则。",
      "Add a style prompt before saving.": "请先填写风格描述。",
      "Cover style saved.": "封面风格已保存。",
      "Cover style selected.": "已选择封面风格。",
      "Keep at least one cover style.": "至少保留一个封面风格。",
      "Cover style removed.": "封面风格已移除。",
      "Editing cover style.": "正在编辑封面风格。",
      "New cover style.": "正在新建封面风格。",
      Use: "使用",
      "In use": "正在使用",
      Selected: "已选择",
      Edit: "编辑",
      Delete: "删除",
      Remove: "移除",
      "Your account style, visual taste, colors, typography mood...": "你的账号风格、视觉偏好、颜色、字体氛围...",
      "Describe your account's default cover style...": "描述这个账号默认的封面风格...",
      "Describe this account's default cover style...": "描述这个账号默认的封面风格...",
      Model: "模型",
      "Batch rounds": "批量轮次",
      "Images per round": "每轮张数",
      Preset: "预设",
      "Cover preset": "封面预设",
      "Minimal editorial": "极简编辑感",
      "Abstract concept": "抽象概念",
      "Product system": "产品系统感",
      "Bold social": "强社媒感",
      "Style and source": "风格与来源",
      "Style and generation options": "风格与生成选项",
      "Default style": "默认风格",
      "Cover style": "封面风格",
      "Manage styles": "管理风格",
      "The last used style is selected automatically.": "会自动选中上次使用的风格。",
      "Advanced generation": "高级生成设置",
      "Cover idea": "封面想法",
      "Cover source text": "封面来源文本",
      "Source text": "来源文本",
      "Selected text, article summary, or cover idea...": "选中文字、文章摘要或封面想法...",
      "Use selected text, paste a summary, or write one sentence for the cover...": "使用选中文字，粘贴摘要，或写一句封面想法...",
      "Describe the cover you want, or use selected text...": "描述你想要的封面，或使用选中文本...",
      "This text is the only thing you need to review before generating.": "生成前只需要确认这段文字。",
      "Only this visible text is sent as the cover idea.": "只会把这里可见的文字作为封面想法发送。",
      "Use selected text": "使用选中文本",
      "Generate covers": "生成封面",
      "Stop generation": "停止生成",
      "Generated covers stay in this side panel session until you close it.": "生成的封面只在当前侧边栏会话中保留，关闭后不会保存。",
      "Covers stay here until the side panel closes.": "封面只保留在当前侧边栏会话中。",
      "No generated covers yet.": "还没有生成的封面。",
      "Set as cover": "设为封面",
      "Add an API key first.": "请先添加 API key。",
      "Add key first": "先添加 Key",
      "Add selected text, a summary, or a cover idea.": "请添加选中文本、文章摘要或封面想法。",
      "Add a cover idea or selected text.": "请添加封面想法或选中文本。",
      "Add source text": "添加来源文本",
      "Add cover idea": "添加封面想法",
      "Ready to generate {count} cover.": "可以生成 {count} 张封面。",
      "Ready to generate {count} covers.": "可以生成 {count} 张封面。",
      "Generate {count} cover": "生成 {count} 张封面",
      "Generate {count} covers": "生成 {count} 张封面",
      "Add your API key in Settings first.": "请先在设置中填写 API key。",
      "Add source text or select part of the draft first.": "请先添加来源文本，或选中草稿中的一段文字。",
      "Generating cover candidates...": "正在生成封面候选图...",
      "Generating round {round}/{total}...": "正在生成第 {round}/{total} 轮...",
      "Generated {count} cover candidate.": "已生成 {count} 张封面。",
      "Generated {count} cover candidates.": "已生成 {count} 张封面。",
      "Candidate {count}": "候选 {count}",
      "Cover generation stopped.": "封面生成已停止。",
      "Cover generation failed.": "封面生成失败。",
      "Cover source text updated.": "封面来源文本已更新。",
      "Select text or add a draft first.": "请先选中文本或添加草稿。",
      "Select text in the draft first, or write a cover idea.": "请先在草稿中选中文本，或直接写封面想法。",
      "API key cleared.": "API key 已清除。",
      "Setting selected cover on the current X Article...": "正在把选中的图片设为当前 X 文章封面...",
      "Selected cover applied to the current X Article.": "已把选中的图片设为当前 X 文章封面。",
      "Open an X Article and run Check before setting a cover.": "请先打开 X 文章并运行检查，再设置封面。",
      "Could not set the selected cover.": "无法设置选中的封面。",
      "Draft cleanup": "草稿清理",
      ...
      Project: "项目",
      "Open the source code or follow release notes from the author.": "打开源码，或关注作者的更新说明。",
      "Open GitHub project": "打开 GitHub 项目",
      "GitHub project": "GitHub 项目",
      "Follow author on X": "在 X 关注作者",
      "Support xPoster": "支持 xPoster",
      "xPoster stays free and local-first. If it saves you publishing time, you can leave a small thank-you here.": "xPoster 会继续免费、优先本地处理。如果它帮你节省了发布时间，可以在这里留下一点心意。",
      "Support options": "支持方式",
      WeChat: "微信",
      "Open the appreciation QR code only when you choose it.": "只有你选择后才打开赞赏码。",
      "Buy Me a Coffee": "Buy Me a Coffee",
      "Open the support QR code only when you choose it.": "只有你选择后才打开支持二维码。",
      "Choose a method first. No payment content appears until you ask for it.": "先选择方式。你主动打开前不会显示付款内容。",
      "Open the Buy Me a Coffee code only for this support method.": "仅显示 Buy Me a Coffee 的支持二维码。",
      "Open the WeChat appreciation code only for this support method.": "仅显示微信赞赏码。",
      "WeChat appreciation QR code": "微信赞赏二维码",
      "Buy Me a Coffee QR code": "Buy Me a Coffee 二维码",
      "Scan with WeChat if xPoster helped you save publishing time.": "如果 xPoster 帮你节省了发布时间，可以用微信扫码支持。",
      "Use Buy Me a Coffee if it is more convenient for you.": "如果 Buy Me a Coffee 更方便，可以用这个方式支持。",
      "Support is optional. Stars, issues, and feedback help too.": "支持完全自愿。Star、issue 和反馈同样有帮助。",
      Done: "完成",
      ...
      "No saved drafts yet": "还没有保存的草稿",
      "Write or check a draft once. It will appear here so you can copy, edit, or write it again.": "写入或检查一次草稿后，它会出现在这里，之后可以复制、编辑或再次写入。",
      "Search saved drafts by title, file, URL, or text": "按标题、文件、链接或正文搜索保存的草稿",
      "Find a saved draft, copy it, edit it, or write it again.": "找到保存过的草稿，复制、编辑或再次写入。",
      "Write or check a draft once. It will appear here for reuse.": "写入或检查一次草稿后，它会出现在这里供你复用。",
      ...
      "Only frontmatter metadata is present. It will not be written as article body.": "当前只有 frontmatter 元数据；它不会作为文章正文写入。",
      "Image preview unavailable": "图片预览不可用",
      "Image source is missing.": "图片来源缺失。",
      ...
      "Inserted as X Markdown table blocks.": "会作为 X Markdown 表格块插入。",
      ...
      "No image or table uploads required.": "无需上传图片或表格。",
      "No image uploads required.": "无需上传图片。",
      Assets: "素材",
      ...
      "Markdown table appears as an X table block.": "Markdown 表格会显示为 X 表格块。",
      "Tweet embed": "推文嵌入",
      ...
      "Open the X editor and run Check so images can upload.": "打开 X 编辑器并运行检查，这样图片才能上传。",
      "Open the X editor and run Check so tables can be inserted.": "打开 X 编辑器并运行检查，这样表格才能插入。",
      "Check editor": "检查编辑器",
      ...
      "Image marker": "图片位置",
      "Markdown table": "Markdown 表格",
      "Markdown table block": "Markdown 表格块",
      "table image": "表格图片",
      "Tweet marker": "推文位置",
      "Code block": "代码块",
      "Code marker": "代码位置",
      ...
      "Tables use X's native Markdown table rendering.": "表格会使用 X 原生 Markdown 表格渲染。",
      "Tables stay editable through X Markdown.": "表格会通过 X Markdown 保持可编辑。",
